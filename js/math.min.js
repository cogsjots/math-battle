...
(function (R, r) {
  ...
  function y(a, b) {
    return (
      (a = g(a)) && new RegExp("(\\s|^)" + b + "(\\s|$)").test(a.className)
    );
  }
    ...
    if (((a = g(a)), (c = c || rf), a && 3 != a.nodeType && 8 != a.nodeType)) {
      ...
      for (var d = 0, f = b.length; f > d; d++) {
        ...
        a.addEventListener
          ...
          : a.attachEvent && a.attachEvent("on" + e, c);
      }
    }
  }
  ...
  function T() {
    ...
    switch (a) {
      ...
      case "/":
        "\u00d7" == a
          ? ((c = l(hard ? 3 : 1, hard ? 20 : 12)),
            (d = l(hard ? 3 : 1, hard ? 20 : 12)),
            (f = c * d))
          : ((f = l(hard ? 3 : 1, hard ? 20 : 12)),
            (d = l(hard ? 3 : 1, hard ? 20 : 12)),
            (c = f * d)),
          b ||
            ((e = Math.min(c, d)),
  ...
  if (q)
    try {
      ...
      C = JSON.parse(E.substr(0, E.length - 32))
        .n.replace(/&/g, "&amp;")
        .replace(/</g, "&lt;")
        .replace(/>/g, "&gt;")
        .replace(/"/g, "&quot;")
  ...
  var k = {
    ...
    start: function (a) {
      a.touches &&
        1 == a.touches.length &&
        (k.end(a), (k.obj = this || null), k.obj && t(k.obj, "hover"));
    },
    cancel: function (a) {
      k.obj && k.end(a);
    },
